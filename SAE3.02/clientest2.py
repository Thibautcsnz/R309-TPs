...
class RoomWindow(QWidget):
    ...
    def __init__(self, username, client_thread, parent):
        super().__init__()
...
class LoginWindow(QWidget):
    ...
    def __init__(self, parent, user_manager, host, port, room):
        ...
        self.port = port
        self.room = room
        self.user_manager = user_manager  # Ajoutez cette ligne pour référencer l'objet user_manager
...
class ChatClient(QMainWindow):
    ...
    def show_room_window(self, username, channel="Général"):
        self.room_window = RoomWindow(username, self.client_thread, self)
